...
$dim(["Spalten"])$. $thin$ | $thin$ $A$ inv. $arrow.l.r "rang"(A) = n$.
...
$det mat(a, b; c, d) = a d - b c$. $thin$ | $thin$ $A$ inv.
$arrow.l.r det(A) eq.not 0$.

== Eigenwerte (EW) & -vektoren (EV) (14.8)
$A v = lambda v$ ($v eq.not 0$). $thin$ | $thin$ EV zu $lambda$ bilden UVR
(14.10). EV zu versch. EW sind l.u. (14.11).\
